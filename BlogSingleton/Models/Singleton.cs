    ...
    public class Singleton
    {
        ...
        private Singleton()
        {
            BlogPosts = new List<BlogPost>()
            {
                ...
                new BlogPost("How Men Take Selfies", "1) Hold phone a little lower than normal. 2) Lower it a little more. 3) Lay it on table. 4) Don't take a selfie. Men don't take selfies.", "http://i.imgur.com/NvvIVPm.jpg")
            };
